...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top px-lg-5 shadow">
    <div class="container">
        ...
        <div class="collapse navbar-collapse p-2 p-md-2" id="navbarNav">
            <ul class="navbar-nav ml-auto py-3 py-md-0">
                ...
                <li class="nav-item dropdown py-2 py-md-0">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('pembanding') }}"><i class="fas fa-chart-bar mr-1"></i> Analisis Pembanding</a>
                        <a class="dropdown-item" href="{{ route('geospasial') }}"><i class="fas fa-map mr-1"></i> Peta Geospasial</a>
                        <a class="dropdown-item" href="{{ route('prediksi') }}"><i class="fas fa-chart-line mr-1"></i> Prediksi</a>
                    </div>
                </li>
                <li class="nav-item py-2 py-md-0">
                    <a class="nav-link {{ request()->routeIs('tujuan') ? 'active' : '' }}" href="{{ route('tujuan.index') }}">
                ...
                <li class="nav-item dropdown py-2 py-md-0">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="{{ route('berita.index') }}"><i class="fas fa-globe mr-1"></i> Berita</a>
                        <a class="dropdown-item" href="{{ route('dokumen') }}"><i class="fas fa-file-alt mr-1"></i> Dokumen</a>
                    </div>
                </li>
                <li class="nav-item py-2 py-md-0">
            ...
            <a href="{{ route('login') }}" class="btn btn-success py-2 px-3 ml-lg-2 mt-2 mt-md-0">
