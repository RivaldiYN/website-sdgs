            ...
            <div class="sm:max-w-[807px] mb-24 mx-auto">
                <div class="ssm:mt-[48px] lg:mt-[150px] h-full">
                    <div class="text-center">
                        <h2 class="text-[24px] font-bold md:text-[30px] lg:text-[48px] font-roboto">Berita Tidak Ditemukan!
                        </h2>
                        <p class="text-[12px] md:text-[18px] lg:text-[24px] font-OpenSans">Berita yang anda cari tidak ada,
                            silahkan lapor jika hal ini merupakan kekeliruan.</p>
                    </div>
                </div>
            </div>
        </section>
