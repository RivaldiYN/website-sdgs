            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form method="POST" action="{{ route('super.berita.store') }}" enctype='multipart/form-data'>
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="judul_berita">Judul Berita</label>
                                    <input name="judul_berita" class="form-control" id="judul_berita" placeholder="Masukkan judul..."
                                        required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div 
                                        x-data
                                        x-init="flatpickr($refs.datetimewidget, {wrap: true, enableTime: false, dateFormat: 'd/m/Y'});"
